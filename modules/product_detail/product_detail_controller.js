define(['angular','app', '../product_detail/product_detail_service'], function (angular, app) {
    'use strict';
    app.controller('product_detail_controller', ['$scope', 'product_detail_service', '$stateParams', '$state','$ionicSlideBoxDelegate','$timeout', function ($scope, product_service, $stateParams, $state,$ionicSlideBoxDelegate,$timeout) {
